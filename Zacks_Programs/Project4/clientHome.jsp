...
<body>
  ...
  <center>
    <h2 h2 style="color:rgb(0, 242, 255);"> A Servlet/JSP-based Multi-tiered Enterprise Application Using A Tomcat
      Containter </h2>
  </center>
  <form action="/Project4/ClientUserServlet" method="get">
    <center>
      <div class="container">
        <label>You are connected to the Project 4 Enterprise System database as a client-level user. </label>
        <br />
        <label>Please enter any valid SQL query or update command in the box below. </label>
        <br />
        <br />
        <textarea rows = "5" cols = "50" style="color: #fefbfb;" type="text" placeholder="select * from suppliers" name="sqlInput"></textarea>
        <br />
